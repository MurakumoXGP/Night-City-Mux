...
CYBERWARE_DATA_LIST = [
    ...
    # Black Chrome Fashionware
    {
        ...
        "cost": 500,
        "is_weapon": False,
        "description": "Sensors track tissue health, bone density, muscle gains. Displays Healthy Persons (HP) heuristic. User knows their own Hit Points at a glance. Requires Biomonitor or Neuroport.",
        "requirements": "Biomonitor or Neuroport",
    },
    ...
    },
{
    ...
    # Interface RED Vol 3: Must Have Cyberware Deals
    {
        ...
        "cost": 500,
        "is_weapon": False,
        "description": "Manage and ignore hunger at touch of button via Biomonitor or Neuroport. Ignore Humanity Loss from Long-term Environmental Stress (starvation). Starvation still an issue: after 7 days without food, Death Save at day start with cumulative +1 per additional day. Requires Biomonitor or Neuroport.",
        "requirements": "Biomonitor or Neuroport",
    },
    {
        "name": "Cyberpillow",
